...
namespace LunarSim
{
    public class AcceleratingSprite : MovingSprite
    {
        ...
        public AcceleratingSprite(Texture2D texture, Vector2 position, Color tint, Vector2 scale, float transparency, Vector2 velocity, Vector2 acceleration, float decelerationFactor)
            : this(texture, position, new Rectangle(0, 0, texture.Width, texture.Height), tint, 1f, new Vector2(texture.Width / 2, texture.Height / 2), scale, SpriteEffects.None, 0, transparency, velocity, acceleration, decelerationFactor) { }
        ...
        public AcceleratingSprite(Texture2D texture, Vector2 position, Color tint, Vector2 scale, Vector2 velocity, Vector2 acceleration, float decelerationFactor)
            : this(texture, position, new Rectangle(0, 0, texture.Width, texture.Height), tint, 1f, new Vector2(texture.Width / 2, texture.Height / 2), scale, SpriteEffects.None, 0, 1.0f, velocity, acceleration, decelerationFactor) { }
